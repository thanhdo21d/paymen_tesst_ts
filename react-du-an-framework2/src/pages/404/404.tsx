  ...
  return (
    <div className="bg-[#3498db] w-full h-[100vh] text-[#ffff] pl-6">
      ...
      <h2 className="text-[23px]">
        A <span className="text-[4rem] font-[600]">404</span> error occured, Page not found, check
        the URL and try again. <br /> Or Your PC ran into a problem and needs to restart. We're just
